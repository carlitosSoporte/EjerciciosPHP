...
<html lang="es">
    ...
    <body>
        ...
        <main>
        <h1>Ejercicio 2</h1>
        <p>2.El gimnasio Bodytech, lo contrata para desarrollar una aplicación web que permita a sus usuarios calcular el índice de masa corporal basado en el formula: 𝐼𝑀𝐶 = 𝑃𝐸𝑆𝑂/ 𝐴𝐿𝑇𝑈𝑅𝐴 ∗ 𝐴𝐿𝑇𝑈𝑅𝐴
