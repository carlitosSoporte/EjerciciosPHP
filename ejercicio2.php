                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="card-title"><?php echo("La Clasificación es Peso normal O Normopeso");?></h2>
                            <p class="card-text">Mantener un peso saludable puede reducir el riesgo de enfermedades crónicas asociadas al sobrepeso y la obesidad.</p>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="card-title"><?php echo("Tienes un sobrepeso grado 1");?></h2>
                            <p class="card-text"> Caminar ayuda a adelgazar. Una caminata rápida de 30 minutos quema 200 calorías. Con el tiempo, las calorías quemadas pueden generar la pérdida de peso.</p>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="card-title"><?php echo("Tienes un Sobrepreso grado II o Preobesidad");?></h2>
                            <p class="card-text">Disminuir la insulina aumenta la quema de grasa, lo que permite la liberación de la grasa corporal almacenada. A largo plazo, esto reduce el hambre e incluso aumenta el gasto de energía, hasta sin ejercicio.</p>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="card-title"><?php echo("Tienes una obesidad de tipo I");?></h2>
                            <p class="card-text">Gracias a sentirse más realizado y mejorar la forma física, las personas que practican ejercicio se sienten mejor y más a gusto consigo mismos, cosa que ayuda a todo el organismo. No hay mejor sistema inmunológico que una buena autoestima y tener estado de ánimo siempre alto y feliz.</p>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="card-title"><?php echo("Tienes una obesidad de tipo II");?></h2>
                            <p class="card-text">Desconectar del ajetreado día a día es muy importante para combatir el estrés, e ir al gimnasio es una buena estrategia para conseguirlo. Te ayudará al relajamiento tanto mental como físico, en definitiva, te hará sentir mejor.</p>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="card-title"><?php echo("Tienes una obesidad de tipo III o Mórbida");?></h2>
                            <p class="card-text">La alimentación y el ejercicio físico son un tándem inseparable. Empezar en el gimnasio significa que aumentará la quema de calorías, para ello deberás reponer de forma saludable con una buena dieta todas estas calorías, logrando así un estilo de vida totalmente saludable.</p>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        ...
                        <h2 class="card-title"><?php echo("Tienes una Obesidad extrema o de Tipo IV");?></h2>
                            <p class="card-text">	Casi la mitad de los pacientes extremadamente obesos desarrollan diabetes, y finalmente las personas obesas tienen mayor dificultad para obtener trabajo y divertirse.</p>
