...
<html lang="es">
    ...
    <body>
        ...
        <main>
        <h1>Ejercicio 7</h1>
        <p>Diseñe un formulario que permita agregar 5 frutas para preparar un salpicón, al ejecutar el programa se debe recibir una url con la imagen de cada fruta ingresada y mostrar en orden la imagen y el nombre de cada fruta</p>
