...
<html lang="es">
    ...
    <body>
        ...
        <main>
        <h1>Ejercicio 9</h1>
        <p>La federación nacional de fútbol también necesita que usted codifique un nuevo programa para establecer el biotipo de losjugadores, teniendo en cuenta la estatura de estos.</p>
